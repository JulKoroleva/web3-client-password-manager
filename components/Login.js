...
const Login = ({
  ...
  const opacityLogoText = useRef(new Animated.Value(0)).current;
  ...
  useEffect(() => {
    Animated.parallel([
      ...
      Animated.timing(opacityLogoText, {
        toValue: 1,
        duration: 700,
        easing: Easing.ease,
        useNativeDriver: false,
  ...
  const marginLeftText = useRef(new Animated.Value(0)).current;
    ...
    <>
      ...
      >
        ...
        <View style={[styles.container, { width: screenWidth, maxWidth: 500 }]}>
          ...
          <Animated.View style={{ opacity: opacityLogo, backgroundColor: theme.bg.mainBg, transform: [{ translateX: opacityLogo.interpolate({ inputRange: [0, 1], outputRange: [30, 0] }) }] }}>
              <Svg
                width="103"
                height="104"
                viewBox="0 0 513 484"
              ...
              >
                <AnimatedPath
                  ...
                  fill={theme.logoText !== "#fff" ? backgroundColorInterpolate : theme.logoText}
                />
                <AnimatedPath
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  ...
                  fill={theme.logoText !== "#fff" ? backgroundColorInterpolate2 : theme.logoText}
                />
                <AnimatedPath
                  fill-rule="evenodd"
                  clip-rule="evenodd"
            ...
            <Animated.Text style={{textTransform:"uppercase", fontWeight:"bold", fontSize:30,  opacity: opacityLogoText, color: theme.logoText !== "#fff" ? backgroundColorInterpolate2 : theme.logoText}}>eb3</Animated.Text>
            <Animated.Text style={{textTransform:"uppercase", fontWeight:"bold", fontSize:30,  opacity: opacityLogoText, marginLeft:-20, color: theme.logoText !== "#fff" ? backgroundColorInterpolate2 : theme.logoText }}>arden</Animated.Text>
            </View>
          </View>
